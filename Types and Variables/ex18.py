...
heightIn = round(heightCm / 2.54, 0)
heightIntegralFt = heightIn // 12
heightRemainingIn = heightIn - heightIntegralFt * 12
print(f"Your height of {heightCm} cm is approximately equal to {int(heightIntegralFt)} feet and {int(round(heightRemainingIn, 0))} inches.")